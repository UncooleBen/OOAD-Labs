 ...
 *
 * <p>
 * This class controls the whole game process, including I/O and error check.
 *
 * @author Shangzhen Li
 */
public class GameController {
	...
	/**
	 * The init() method is used as the main menu. Loop infinitely until user quits
	 * the program.
	 */
	public void init() {
		int op;
	...
	/**
	 * Every time startGame() is called, a new round of game begins with the current
