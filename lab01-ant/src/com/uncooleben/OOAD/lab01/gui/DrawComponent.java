...
/**
 * A class that draws the process of the program void paintComponent(Graphics) will be called
 * automatically. Never call it manually.
 *
 * <p>
 *
...
public class DrawComponent extends JComponent {
    ...
    for (Ant ant : this.pole.getAnts()) {
      ...
      Rectangle2D antRect =
          new Rectangle2D.Double(
              centerX - width / 2 + ratio * ant.getLocation(), centerY - 2.5, 10, 10);
  ...
  private void setColor(@NotNull Graphics2D g2, Rectangle2D rect, Color color) {
    g2.setPaint(color);
    g2.fill(rect);
  }
}
